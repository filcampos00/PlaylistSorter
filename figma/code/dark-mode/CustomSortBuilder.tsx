      ...
      {levels.length === 0 ? (
        ...
        <>
            ...
            return (
              ...
              >
                ...
                <select
                  ...
                  className="w-full bg-zinc-700/50 border border-zinc-600 rounded-lg px-4 py-2.5 text-zinc-100 mb-3 focus:outline-none focus:ring-2 focus:ring-purple-500"
                >
          ...
          {canAddMore && availableForNext.length > 0 && (
            <button
              onClick={handleAddLevel}
              className="w-full py-3 rounded-lg border-2 border-dashed border-zinc-700 hover:border-purple-600/50 hover:bg-purple-600/5 text-zinc-500 hover:text-purple-400 transition-all flex items-center justify-center gap-2"
            >
              <Plus className="w-4 h-4" />
