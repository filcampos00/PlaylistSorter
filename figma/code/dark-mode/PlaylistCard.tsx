...
export function PlaylistCard({ name, trackCount, thumbnail, onSort }: PlaylistCardProps) {
  return (
    <div className="group cursor-pointer">
      <div className="relative aspect-square rounded-xl overflow-hidden bg-zinc-900 mb-4 shadow-lg">
        <img
          src={thumbnail}
          alt={name}
      ...
      <div className="px-1">
        <h3 className="mb-1 group-hover:text-purple-400 transition-colors truncate">
          {name}
        </h3>
