...
import type { AlbumOrder, LastFmPeriod, TopArtistsResponse } from "../types";
...
interface FavouriteArtistsInputProps {
    ...
    onAlbumOrderChange: (order: AlbumOrder) => void;
    disabled?: boolean;
}
...
const ALBUM_ORDER_LABELS: Record<AlbumOrder, string> = {
    newest: "Albums: Newest → Oldest",
    oldest: "Albums: Oldest → Newest",
};
...
export const FavouriteArtistsInput = ({
    ...
    return (
        <div className="favourite-artists-input">
            ...
            <div className="album-order-section">
                <label className="album-order-label">Album order:</label>
                <select
                    className="album-order-select"
                    value={albumOrder}
                    onChange={(e) => onAlbumOrderChange(e.target.value as AlbumOrder)}
                    disabled={disabled}
                >
                    {Object.entries(ALBUM_ORDER_LABELS).map(([value, label]) => (
            ...
            <div className="info-callout">
                ...
                <span className="info-text">
                    Tracks from other artists will be sorted alphabetically (A-Z).
                </span>
            </div>
        </div>
    );
